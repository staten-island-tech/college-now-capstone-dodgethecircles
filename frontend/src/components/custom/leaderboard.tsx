            ...
            <div className="grid w-full grid-cols-3 items-center text-center">
              <div className="relative w-full flex justify-center items-center">
                ...
                <Avatar className="opacity-80 mx-auto">
                  <AvatarImage
                    src={`${process.env.NEXT_PUBLIC_BACKEND_URL}/pfp/${players[0].pfp}`}
                  />
                  <AvatarFallback>CN</AvatarFallback>
                </Avatar>
              </div>
              <h4 className="text-base w-full overflow-hidden whitespace-nowrap text-ellipsis">
                {players[0].username}
              </h4>
              <h4 className="text-base w-full overflow-hidden whitespace-nowrap text-ellipsis">
                {players[0].highscore}{" "}
            ...
            <span>
              ...
              <div className="grid w-full grid-cols-3 items-center text-center">
                <div className="relative w-full flex justify-center items-center">
                  ...
                  <Avatar className="opacity-80 mx-auto">
                    <AvatarImage
                      src={`${process.env.NEXT_PUBLIC_BACKEND_URL}/pfp/${players[1].pfp}`}
                    />
                    <AvatarFallback>CN</AvatarFallback>
                  </Avatar>
                </div>
            ...
            <span>
              ...
              <div className="grid w-full grid-cols-3 items-center text-center">
                <div className="relative w-full flex justify-center items-center">
                  ...
                  <Avatar className="opacity-80 mx-auto">
                    <AvatarImage
                      src={`${process.env.NEXT_PUBLIC_BACKEND_URL}/pfp/${players[2].pfp}`}
                    />
                    <AvatarFallback>CN</AvatarFallback>
                  </Avatar>
                </div>
            ...
            <div key={index}>
              ...
              <div className="grid w-full grid-cols-3 items-center text-center">
                <div className="relative w-full flex justify-center items-center">
                  ...
                  <Avatar className="opacity-80 mx-auto">
                    <AvatarImage
                      src={`${process.env.NEXT_PUBLIC_BACKEND_URL}/pfp/${player.pfp}`}
                    />
                    <AvatarFallback>CN</AvatarFallback>
                  </Avatar>
                </div>
